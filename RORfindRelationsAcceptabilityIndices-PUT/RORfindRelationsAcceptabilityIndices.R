##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORfindRelationsAcceptabilityIndices.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORfindRelationsAcceptabilityIndices.R
##########################################
...
#OUTPUT FILES:
result.file <- "relations-acceptability-indices.xml"
...
if (execFlag) {
  ...
  newXMLNode("xmcda:XMCDA",
             ...
             parent=outTree)
  rorranking:::putAlternativesMatrix(tree=outTree, alternativesMatrix=results)
