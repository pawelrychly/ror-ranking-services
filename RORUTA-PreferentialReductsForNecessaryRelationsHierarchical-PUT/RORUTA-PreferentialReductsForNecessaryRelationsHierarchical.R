##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORUTA-PreferentialReductsForNecessaryRelationsHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORUTA-PreferentialReductsForNecessaryRelationsHierarchical.R
##########################################
  ...
  tmpErr<- try (
    {
      results <- findPreferentionalReductsForNecessaryRelationsHierarchical(
        ...
        strict.vf=strict, nums.of.characteristic.points=nums.of.characteristic.points, criteria=criteria.preference.directions,
