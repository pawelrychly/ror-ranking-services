##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORfindPreferenceRelatedDeteriorationOrSurplusValueHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORfindPreferenceRelatedDeteriorationOrSurplusValueHierarchical.R
##########################################
