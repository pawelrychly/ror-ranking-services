...
if (execFlag) {
  ...
  print(nec.relations)
  putAlternativesComparisonsLabels(outTreeNec, nec.relations, mcdaConcept="necessaryRelations")
  putAlternativesComparisonsLabels(outTreePos, pos.relations, mcdaConcept="possibleRelations")
