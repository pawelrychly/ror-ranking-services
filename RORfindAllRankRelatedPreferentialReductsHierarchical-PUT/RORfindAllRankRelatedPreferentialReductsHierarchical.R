##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORfindAllRankRelatedPreferentialReductsHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORfindAllRankRelatedPreferentialReductsHierarchical.R
##########################################
