##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < findPreferenceRelatedDeteriorationOrSurplusValue.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < findPreferenceRelatedDeteriorationOrSurplusValue.R
##########################################
