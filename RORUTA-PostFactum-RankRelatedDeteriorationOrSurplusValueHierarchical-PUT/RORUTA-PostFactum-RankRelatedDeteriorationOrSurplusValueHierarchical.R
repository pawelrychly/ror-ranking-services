##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORUTA-PostFactum-RankRelatedDeteriorationOrSurplusValueHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORUTA-PostFactum-RankRelatedDeteriorationOrSurplusValueHierarchical.R
##########################################
