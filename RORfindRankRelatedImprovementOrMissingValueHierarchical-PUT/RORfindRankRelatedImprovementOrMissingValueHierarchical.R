##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORfindRankRelatedImprovementOrMissingValueHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORfindRankRelatedImprovementOrMissingValueHierarchical.R
##########################################
