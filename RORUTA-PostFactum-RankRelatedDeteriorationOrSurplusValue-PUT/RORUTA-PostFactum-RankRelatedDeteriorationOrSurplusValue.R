##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORUTA-PostFactum-RankRelatedDeteriorationOrSurplusValue.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORUTA-PostFactum-RankRelatedDeteriorationOrSurplusValue.R
##########################################
