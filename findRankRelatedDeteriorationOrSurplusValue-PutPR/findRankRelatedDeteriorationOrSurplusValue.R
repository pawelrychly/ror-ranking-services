##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < findRankRelatedDeteriorationOrSurplusValue.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < findRankRelatedDeteriorationOrSurplusValue.R
##########################################
