##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORfindRankRelatedDeteriorationOrSurplusValue.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORfindRankRelatedDeteriorationOrSurplusValue.R
##########################################
