##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < findRelationsAcceptabilityIndices.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < findRelationsAcceptabilityIndices.R
##########################################
