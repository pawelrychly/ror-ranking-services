##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORfindRankRelatedImprovementOrMissingValue.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORfindRankRelatedImprovementOrMissingValue.R
##########################################
