##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < findRelationsAcceptabilityIndicesHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < findRelationsAcceptabilityIndicesHierarchical.R
##########################################
