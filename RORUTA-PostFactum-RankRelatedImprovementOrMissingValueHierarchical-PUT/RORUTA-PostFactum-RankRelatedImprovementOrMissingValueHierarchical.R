##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORUTA-PostFactum-RankRelatedImprovementOrMissingValueHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORUTA-PostFactum-RankRelatedImprovementOrMissingValueHierarchical.R
##########################################
