##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < findPreferenceRelatedImprovementOrMissingValueHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < findPreferenceRelatedImprovementOrMissingValueHierarchical.R
##########################################
