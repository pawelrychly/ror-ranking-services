##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < findPreferentionalReductsForNecessaryRelationsHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < findPreferentionalReductsForNecessaryRelationsHierarchical.R
##########################################
