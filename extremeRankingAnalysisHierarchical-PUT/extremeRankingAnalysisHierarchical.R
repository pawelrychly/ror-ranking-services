##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < extremeRankingAnalysisHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < extremeRankingAnalysisHierarchical.R
##########################################
