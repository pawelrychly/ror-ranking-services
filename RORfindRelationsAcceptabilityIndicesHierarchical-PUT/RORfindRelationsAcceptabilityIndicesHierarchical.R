##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORfindRelationsAcceptabilityIndicesHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORfindRelationsAcceptabilityIndicesHierarchical.R
##########################################
...
#OUTPUT FILES:
result.file <- "relations-acceptability-indices-hierarchical.xml"
