##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORUTA-PostFactum-PreferenceRelatedDeteriorationOrSurplusValue.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORUTA-PostFactum-PreferenceRelatedDeteriorationOrSurplusValue.R
##########################################
