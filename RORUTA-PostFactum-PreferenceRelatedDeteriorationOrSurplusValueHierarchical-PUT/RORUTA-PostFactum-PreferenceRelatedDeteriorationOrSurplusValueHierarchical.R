##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORUTA-PostFactum-PreferenceRelatedDeteriorationOrSurplusValueHierarchical.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORUTA-PostFactum-PreferenceRelatedDeteriorationOrSurplusValueHierarchical.R
##########################################
