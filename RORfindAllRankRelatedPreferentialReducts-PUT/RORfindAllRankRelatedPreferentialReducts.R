##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORfindAllRankRelatedPreferentialReducts.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORfindAllRankRelatedPreferentialReducts.R
##########################################
