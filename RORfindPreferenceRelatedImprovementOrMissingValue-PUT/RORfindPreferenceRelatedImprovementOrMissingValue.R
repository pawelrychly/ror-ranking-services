##########################################
# Usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < RORfindPreferenceRelatedImprovementOrMissingValue.R
# Example: 
# R --slave --vanilla --args "${PWD}/in" "${PWD}/out" < RORfindPreferenceRelatedImprovementOrMissingValue.R
##########################################
